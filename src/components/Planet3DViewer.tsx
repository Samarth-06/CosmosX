...
export default function Planet3DViewer({
  ...
  const FallbackUI = () => (
    ...
    >
      ...
      <div className="absolute border border-dashed rounded-full w-[85%] h-[85%] opacity-25 animate-spin" style={{ borderColor: color, animationDuration: "30s" }} />
      <div className="absolute border border-dotted rounded-full w-[65%] h-[65%] opacity-40 animate-spin" style={{ borderColor: color, animationDuration: "15s" }} />
